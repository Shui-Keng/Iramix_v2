...
| P0-012 | Disk and session resilience | Background schema serialization and revisioned Java/C++ durable-save completion verified on three-OS CI/sanitizers; atomic recovery, bounded workers, schema v3, migrations, and reference benchmark covered; production-session ownership, complete state, cold hardware benchmarks, and media/plugin restoration pending |
