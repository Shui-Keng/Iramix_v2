...
| P0-008 | Audio callback probes | Windows open: 64 cadence failed; Core Audio/JACK probes added but target runs pending; proprietary SDK path resolved, signing pending; three 2h soaks pending; shared-mode buffer-size assertion is exclusive-mode-shaped and rejects a valid shared ring (see DEVICE_ENUMERATION_WINDOWS_2026-07-28) |
