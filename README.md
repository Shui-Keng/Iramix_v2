...
Fail-closed automatic restore and its journal-baseline compatibility gates are
recorded in
[`docs/phase-0/results/AUTOMATIC_BACKUP_RESTORE_2026-07-28.md`](docs/phase-0/results/AUTOMATIC_BACKUP_RESTORE_2026-07-28.md).
